    ...
    public static void main(String[] args) {
        ...
        for(int x = 1; x <= 100; x++) {
            ...
            System.out.println("insert into profile\n" +
                "values (" + x + ", 'user_" + x + "', 'user_" + x + "@email.com', 'pass"+x+"', '" + gc.get(gc.YEAR) + "-" + (gc.get(gc.MONTH) + 1) + "-" + gc.get(gc.DAY_OF_MONTH) + "', to_timestamp('10-JAN-2019 09:00:00', 'DD-MON-YYYY HH24:MI:SS'));");
        }
        ...
        for(int z = 1; z <= 10; z++)
        {
            //System.out.println("insert into group\n" +
        ...
        for(int z1 = 1; z1 <= 300; z1++)
        {
            ...
            //System.out.println("insert into message\n" + 
           // "values (" + msgID + ", " + fromID + ", '" + message + " " + z1 + "', NULL" + ", NULL"+ ", '" + 
          //  + gc.get(gc.YEAR) + "-" + (gc.get(gc.MONTH) + 1) + "-" + gc.get(gc.DAY_OF_MONTH) + "', to_timestamp('10-JAN-2019 09:00:00', 'DD-MON-YYYY HH24:MI:SS'));");
        }
    }
}
